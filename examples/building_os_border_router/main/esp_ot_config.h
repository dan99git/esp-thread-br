/**
 * Building OS Border Router OpenThread host/RCP configuration.
 *
 * The S3 runs the BOS border-router host firmware. The H2 runs OpenThread RCP
 * firmware and is reached over the board UART plus reset/boot pins.
 */
